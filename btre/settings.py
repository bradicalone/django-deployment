...
SECRET_KEY = '9^aks(rp@os(*c@_3z3!-)25je%#fgd8rx7usxp=mo0xxexb6g'
...
INSTALLED_APPS = [
    ...
    'contacts.apps.ContactsConfig',  # Add this from realtors/apps.py, recognize this as an app
...
EMAIL_PORT = 587
EMAIL_HOST_USER='jerrycurljackson@gmail.com'
EMAIL_HOST_PASSWORD=''
EMAIL_USE_TLS=True